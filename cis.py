            ...
            for tmp_sub in sub_list:
                ...
                for tmp_ses in ses_list:
                    ...
                    if args.protocol_check:
                        cmd = ('python ./protocol_check.py -w {work} --bids_dir {bids_dir} --sub {sub} --ses {ses}'.format(work=raw_work_dir, bids_dir = args.bids_dir, sub=tmp_sub, ses=tmp_ses))
                        run(cmd)
